...
public class TemperatureConvertorServiceLocator extends org.apache.axis.client.Service implements com.metacube.webservices.TemperatureConvertorService {
    ...
    private java.lang.String TemperatureConvertor_address = "http://localhost:8080/SimpleSOAPExample/services/TemperatureConvertor";
    ...
    public com.metacube.webservices.TemperatureConvertor getTemperatureConvertor() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.webservices.TemperatureConvertor getTemperatureConvertor(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.webservices.TemperatureConvertorSoapBindingStub _stub = new com.metacube.webservices.TemperatureConvertorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.webservices.TemperatureConvertor.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.webservices.TemperatureConvertorSoapBindingStub _stub = new com.metacube.webservices.TemperatureConvertorSoapBindingStub(new java.net.URL(TemperatureConvertor_address), this);
                _stub.setPortName(getTemperatureConvertorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.metacube.com", "TemperatureConvertorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.metacube.com", "TemperatureConvertor"));
        }
